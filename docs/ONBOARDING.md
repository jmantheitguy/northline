...
2. The member signs in at the Northline URL with Authentik and completes account recovery information.
3. In Authentik profile settings, the member links Discord and confirms their profile picture.
