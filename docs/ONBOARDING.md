...
3. In Authentik profile settings, the member optionally links Discord. Northline uses that link only for the member's profile picture and targeted Task Buddy reminder mentions; the office email and Authentik identity remain authoritative.
