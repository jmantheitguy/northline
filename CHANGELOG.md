...
- Keep authorized Authentik superusers and Domain Admins visible as normal directory profiles.
- Continue hiding only Northline's configured local emergency Administrator from member-facing directories and collaboration flows.
...
- Keep the configured local emergency administrator out of user-facing directories and collaboration pickers without disabling management access.
